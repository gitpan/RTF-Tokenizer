...
ok( eq_array( [$tokenizer->get_token()], ['control', 'I', '0'] ), 'Read control' );
ok( eq_array( [$tokenizer->get_token()], ['control', 'rock', ''] ), 'Read control' );
ok( eq_array( [$tokenizer->get_token()], ['control', '*', ''] ), 'Read control' );
